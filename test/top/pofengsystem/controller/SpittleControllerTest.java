...
import top.pofengsystem.data.SpittleRepository;
...
public class SpittleControllerTest {
    ...
    public void shouldShowRecentSpittles() throws Exception {
        ...
        standaloneMockMvcBuilder.setSingleView(new InternalResourceView("/WEB_INF/view/spittles.jsp"));
        MockMvc mockMvc = standaloneMockMvcBuilder.build();
